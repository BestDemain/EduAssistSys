...
/**
 * 知识点掌握程度与正确率关系图组件
 * 使用D3.js实现的散点图，展示知识点掌握程度与正确率的关系
 * @param {Object} props
 * @param {Array} props.data 知识点数据数组
 * @param {string} props.title 图表标题
 */
const KnowledgeScatterPlot = ({ data, title = '知识点掌握程度与正确率关系图' }) => {
  ...
  useEffect(() => {
    ...
    svg.selectAll('.dot')
      ...
      .on('mouseover', function(event, d) {
        ...
        tooltip.html(`
          <strong>知识点:</strong> ${d.knowledge}<br/>
...
export default KnowledgeScatterPlot;